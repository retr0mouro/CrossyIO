...
```bash
$ git clone git@gitlab.com:uminho-di/li1/2223/2022li1g044.git
$ cd 2022li1g044
```
...
```bash
$ git clone https://gitlab.com/uminho-di/li1/2223/projetos/2022li1g044.git
$ cd 2022li1g044
```
...
- **A104360** David Figueiredo ;
- **A104266** Diogo Ferreira;
